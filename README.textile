This project is an agroupation of exercises for some subjects in my degree.
...
Initially all values are set to 0 (the dirty marker too). Clients comunicate with the servers (only one server attends a request) trought the message queues
