...
It consists on making a simple database design and a PHP application for managing a private messaging area, which will contain users and departments, manage
diferent user privileges and hability to send messages to single users or departments (aka user groups).
